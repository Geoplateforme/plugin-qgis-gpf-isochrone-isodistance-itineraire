...
from gpf_isochrone_isodistance_itineraire.processing.isochrone import (
    IsochroneProcessing,
)
...
from gpf_isochrone_isodistance_itineraire.processing.itinerary_batch import (
    BatchItineraryAlgorithm,
)
...
class PluginGpfIsochroneIsodistanceItineraireProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        self.addAlgorithm(BatchItineraryAlgorithm())
    ...
    def id(self) -> str:
        ...
        :rtype: str
        """
        return "gpf_isochrone_isodistance_itineraire"
