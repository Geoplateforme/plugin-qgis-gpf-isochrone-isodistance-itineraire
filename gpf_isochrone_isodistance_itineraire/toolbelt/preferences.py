...
from gpf_isochrone_isodistance_itineraire.__about__ import __title__, __version__
from gpf_isochrone_isodistance_itineraire.toolbelt.env_var_parser import EnvVarParser

# ############################################################################
# ########## Classes ###############
# ##################################

PREFIX_ENV_VARIABLE = "QGIS_GPF_ISOCHRONE_ISODISTANCE_ITINERAIRE_"
